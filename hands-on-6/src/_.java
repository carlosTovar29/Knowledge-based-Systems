...
class RouterDemo implements ActionListener {
    ...
    RouterDemo() {
        try {
            routerResources = ResourceBundle
                    .getBundle("net.sf.clipsrules.jni.examples.router.resources.RouterResources", Locale.getDefault());
    ...
    public void runAnimal() {
        String animalFileNames[] = { "bcengine.clp",
                "animal.clp",
