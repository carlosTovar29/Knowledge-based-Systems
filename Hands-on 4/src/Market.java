  ...
  private class TellBehaviour extends Behaviour  {
    ...
    public void action() {
      ...
      try {
        ...
        clips.eval("(load \"market/templates.clp\")");
        clips.eval("(load \"market/facts.clp\")");
        clips.eval("(load \"market/persons.clp\")");
        clips.eval("(load \"market/rules.clp\")");
        clips.eval("(assert (hecho a))");
